...
//		    TODO: if the option to store file as file url
		...
		public function callback_media( $args ) {
			...
			$image_style = ! is_array( $image_size ) ? "style='max-width:{$max_width}px'; height:auto;'" : "style='width:{$width}px; height:{$height}px;'";
			...
			echo '
                <div class="upload">
                    ...
                    <div>
                        ...
                        <button type="submit" class="boospot-image-upload button action">' . $text . '</button>
                        <button type="submit" class="boospot-image-remove button remove">&times;</button>
                    </div>
								</div>
