...
function ewlwat_settings_page() {
  ...
  $config_array['menu']     = array(
    'page_title'            => __( 'gu•theme•berg', 'ewlwat' ),
    'menu_title'            => __( 'Admin Theme', 'ewlwat' ),
  ...
  $config_array['fields']   = array(
    ...
    'general_section' => array(
      ...
      array(
        'id'    => 'emojify_warning',
        'label' => __( 'Emojify Warning', 'ewlwat' ),
        'desc'  => __( 'Emojify is beta. We tried to cover the most common plugins, however, it may be that some plugin, especially the more specific ones, does not have a registered emoji. This will make it appear in the menu without an icon. To register an emoji, open an issue <a href="https://github.com/jeffsmonteiro/ewlwat/issues" target="_blank">here</a>.', 'ewlwat' ),
        'type'  => 'html'
      ),
  ...
  $config_array['links']    = array(
    ...
    'action_links'    => array(
      ...
      array(
        'type' => 'internal',
        'text' => __( 'Gravity Forms', 'ewlwat' ),
        'url'  => 'admin.php?page=gf_edit_forms',
      ),
      array(
        'type' => 'external',
        'text' => __( 'Github Repo', 'ewlwat' ),
